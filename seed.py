...
ANIME = [
    ...
    },
    {
        ...
        "synopsis_en": "A quiet middle schooler with immense psychic power tries to live a normal life, only unleashing his abilities when his emotional meter hits 100% — but keeping his feelings bottled up may be more dangerous than the powers themselves.",
        "genre_en": "Comedy, Drama, Supernatural",
        "synopsis": "強力な超能力を持ちながら、感情の昂りが100%に達した時しか力を使わない目立たない中学生・モブ。"
                    "「個性のひとつに過ぎない力」とどう向き合うかを描く、超能力青春グラフィティ。",
        "episode_count": 37,
        "release_year": 2016,
        "genre": "コメディ,ドラマ,SF",
        "is_airing": 0,
    ...
    },
    {
        ...
        "title_kana": "どくたーすとーん",
        "title_en": "Dr. Stone",
        "synopsis_en": "When a mysterious light turns all of humanity to stone, a brilliant science-obsessed teenager awakens thousands of years later and sets out to rebuild civilization from scratch using nothing but the power of science.",
        "genre_en": "Sci-Fi, Adventure",
        "synopsis": "謎の光によって人類が石化してから数千年後、科学好きの高校生・千空が目を覚ます。"
                    "何もない世界で、科学の力だけを武器に文明をゼロから再建していく知的冒険アニメ。",
        "episode_count": 24,
        "release_year": 2019,
        "genre": "SF,冒険",
        "is_airing": 1,
    ...
    {
        "slug": "shokugeki-no-soma",
        "title": "食戟のソーマ",
        "title_kana": "しょくげきのそーま",
        "title_en": "Food Wars!",
        "synopsis_en": "A young chef who grew up in his family's modest diner enrolls in an elite culinary school with a brutal 10% graduation rate, taking on high-stakes cooking duels to prove his skills against the school's best.",
        "genre_en": "Comedy, Gourmet, School",
        "synopsis": "実家の定食屋を手伝いながら料理の腕を磨いてきた少年は、卒業率1割という超エリート料理学校へ入学する。"
                    "「食戟」と呼ばれる料理対決を通じて、己の料理を磨き上げていく熱血グルメアニメ。",
        "episode_count": 24,
        "release_year": 2015,
        "genre": "コメディ,グルメ,学園",
        "is_airing": 0,
    ...
    },
    {
        ...
        "title": "とある魔術の禁書目録",
        "title_kana": "とあるまじゅつのいんでっくす",
        "title_en": "A Certain Magical Index",
        "synopsis_en": "In a city where science and supernatural power collide, a boy whose right hand can nullify any ability meets a mysterious nun on the run from the world of magic, and finds himself caught between two hidden worlds.",
        "genre_en": "Fantasy, Sci-Fi, Action",
        "synopsis": "科学技術で超能力を生み出す「学園都市」を舞台に、あらゆる異能を打ち消す右手を持つ少年は、"
                    "魔術の世界から逃げてきた少女との出会いをきっかけに、科学と魔術、2つの世界の狭間に立たされていく。",
        "episode_count": 24,
        "release_year": 2008,
        "genre": "ファンタジー,SF,アクション",
        "is_airing": 0,
        "availability": [
            {"service": "Abema", "plan_type": "subscription", "watch_url": "https://abema.tv/"},
            {"service": "dアニメストア", "plan_type": "subscription", "watch_url": "https://anime.dmkt-sp.jp/"},
...
SEASONS = {
    ...
    "mob-psycho-100": [
        {"label": "シーズン1", "subtitle": None, "kind": "tv", "release_year": 2016, "episode_count": 12},
        {"label": "シーズン2", "subtitle": None, "kind": "tv", "release_year": 2019, "episode_count": 13},
        {"label": "シーズン3", "subtitle": None, "kind": "tv", "release_year": 2022, "episode_count": 12},
    ],
    "dr-stone": [
        {"label": "シーズン1", "subtitle": None, "kind": "tv", "release_year": 2019, "episode_count": 24},
        {"label": "STONE WARS", "subtitle": None, "kind": "tv", "release_year": 2021, "episode_count": 11},
        {"label": "NEW WORLD", "subtitle": None, "kind": "tv", "release_year": 2023, "episode_count": 22},
        {"label": "SCIENCE FUTURE", "subtitle": None, "kind": "tv", "release_year": 2025, "episode_count": None},
    ],
    "shokugeki-no-soma": [
        {"label": "シーズン1", "subtitle": None, "kind": "tv", "release_year": 2015, "episode_count": 24},
        {"label": "弐ノ皿", "subtitle": None, "kind": "tv", "release_year": 2016, "episode_count": 13},
        {"label": "餐ノ皿", "subtitle": None, "kind": "tv", "release_year": 2017, "episode_count": 12},
        {"label": "神ノ皿", "subtitle": None, "kind": "tv", "release_year": 2019, "episode_count": 12},
        {"label": "豪ノ皿", "subtitle": None, "kind": "tv", "release_year": 2020, "episode_count": 12},
    ],
    "toaru-majutsu-no-index": [
        {"label": "シーズン1", "subtitle": None, "kind": "tv", "release_year": 2008, "episode_count": 24},
        {"label": "シーズン2", "subtitle": None, "kind": "tv", "release_year": 2010, "episode_count": 24},
        {"label": "劇場版", "subtitle": "エンデュミオンの奇蹟", "kind": "movie", "release_year": 2013, "episode_count": None},
        {"label": "シーズン3", "subtitle": None, "kind": "tv", "release_year": 2018, "episode_count": 26},
    ],
}
